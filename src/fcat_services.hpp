#ifndef FCAT_SERVICES_HPP_
#define FCAT_SERVICES_HPP_
...
class FcatServices : public rclcpp::Node
{
 private:
  typedef enum {
 ...
 private:
  ...
  const rmw_qos_profile_t services_qos_ = rmw_qos_profile_services_default;
  ...
  void AsyncSdoReadSrvCb(
      const std::shared_ptr<fcat_msgs::srv::AsyncSdoReadService::Request>
                                                                     request,
